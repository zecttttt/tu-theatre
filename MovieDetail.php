          ...
          <div class="row justify-content-center">
                          ...
                          <div class="row">
                              ...
                              <div class="col-lg-6">
								...
								<?php while($GenreResult = mysqli_fetch_assoc($query3)): ?>
                                          <button class="btn btn-primary shadow float-start" id="ButtonGenre" style="margin-left: 10px;font-family: Kanit, sans-serif;width: 110px;"><?=$GenreResult['FilmGenre']?></button>
								<?php endwhile; ?> 
                                          <br><br><br>
									<?php
			...
			{	  
									...
									$countreview=mysqli_fetch_array($countreview);
                    					...
                    					echo "<p class='fw-bold float-start mb-0' id='RatingLabel' style='width: 97px;color: rgb(20,0,255);font-family: Kanit, sans-serif;margin-top:-37px;'>Duration</p>";
										echo "<p class='text-muted float-start mb-0' id='RatingScore' style='margin-top:-37px;margin-left: 80px;'>".$row['FilmDuration']."</p>";
            }                           ?> 
			 <?php
$Title = $search;
